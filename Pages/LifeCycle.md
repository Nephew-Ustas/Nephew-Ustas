...
## Установка и запуск
0. Создай подпись для твоих проектов. Для этого:
...
4. После этого в директории проекта необходимо исполнить скрипт из `makefile`:
...
5. Для внесения изменений ветки в репозиторий вызвать
